  ...
  return (
    <>
      <h2 className="mb-4 flex gap-2 text-base font-semibold dark:text-gray-200">
        <Layers3 className="icon-lg text-blue-500" />
                    ...
                    return (
                      <Tag
                        ...
                        className={cn(
                          ...
                          tag === 'production' &&
                            'bg-green-100 text-blue-500 dark:border-blue-500 dark:bg-transparent dark:text-blue-500',
                        )}
                        labelClassName="flex m-0 justify-center gap-1"
                        LabelNode={
                          tag === 'production' ? (
                            <div className="flex items-center ">
                              <span className="slow-pulse h-[0.4rem] w-[0.4rem] rounded-full bg-blue-400" />
                            </div>
                          ) : null
                        }
                      />
