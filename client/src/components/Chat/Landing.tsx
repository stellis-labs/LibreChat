...
import {
  ...
  LANDING_PAGE_BOT_NAME,
  LANDING_PAGE_BOT_PROMPT_1,
  LANDING_PAGE_BOT_PROMPT_2,
  LANDING_PAGE_BOT_PROMPT_3,
  LANDING_PAGE_BOT_PROMPT_4,
  LANDING_PAGE_BOT_TAG_LINE,
} from "~/utils/stellis/constants"
...
export default function Landing({ Header }: { Header?: ReactNode }) {
  ...
  const avatar = isAgent
    ...
    : (((entity as t.Assistant | undefined)?.metadata?.avatar as
        | string
        | undefined) ?? "")
      ...
      <div className="flex h-full flex-col items-center justify-center overflow-y-auto">
        <div className={cn("relative", name && avatar ? "mb-0" : "mb-3")}>
          {/* <ConvoIcon
            ...
            size={41}
          /> */}
          <ProfileImg src={RESUME_BOT_IMAGE_URL} alt="max_img" size={100} />
        ...
        {name ? (
          ...
          <h2 className="mb-5 flex max-w-[85vh] flex-col gap-2 px-12 text-center text-lg font-medium dark:text-white md:px-0 md:text-2xl">
            <div className="">
            ...
            <div className="mx-auto mt-8 flex w-fit flex-wrap gap-2 md:gap-4">
              ...
              <ChatPrompt prompt={LANDING_PAGE_BOT_PROMPT_4} />
            </div>
          </h2>
        )}
