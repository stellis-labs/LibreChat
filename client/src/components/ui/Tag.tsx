...
const TagPrimitiveRoot = React.forwardRef<HTMLDivElement, TagProps>(
  (
    ...
    <div
      ...
      {...props}
      className={cn(
        'flex max-h-8 items-center overflow-y-hidden rounded-3xl border-2 border-blue-600 bg-blue-600/20 text-xs text-blue-600 dark:text-white',
        className,
      )}
    >
      ...
      {CancelButton
        ...
        : onRemove && (
          <button
            ...
            className="rounded-full bg-blue-600/50"
